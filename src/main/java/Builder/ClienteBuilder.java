...
public class ClienteBuilder {
	public static Cliente build(int codigoCliente, String nombreCliente, String contactoCliente, String apellidoCliente,
			...
			int codigoEmpleadoRepVentas, double limiteCredito, TipoDocumento tipoDocumento, String DNI, String email,
			String password) throws FormatoIncorrecto {
		...
		Cliente clienteABuildear = new Cliente(codigoCliente, nombreCliente, contactoCliente, apellidoCliente,
				...
				paisCliente, codigoPostalCliente, codigoEmpleadoRepVentas, limiteCredito, tipoDocumento, DNI, email,
				password);
